...
const BreadCrum: React.FC<BreadCrumProps> = ({ onSearch, setSelectedFilter, selectedFilter }) => {
    ...
    return (
        <div className="space-y-3">
            <div>
                <h1 className="text-[#11401C] font-semibold text-[24px]">User Management</h1>
                <p className="text-[#646464] font-medium text-[14px]">Efficiently Administer User Accounts, Roles, and Permissions</p>
            </div>
