...
const BreadCrum: React.FC<BreadCrumProps> = ({ onSearch, onOpen }) => {
  ...
  return (
    <div className="space-y-3">
      <div>
        <h1 className="text-[#11401C] font-semibold text-[24px]">Educational Videos</h1>
        <p className="text-[#646464] font-medium text-[14px]">Manage your educational videos and upload new content to support allergy awarness.</p>
      </div>
      <div className="flex items-center justify-between">
        <div className="flex items-center px-3 gap-2 border border-[#D5D5D5] rounded-full w-[388px] h-[38px] focus-within:ring-1 focus-within:ring-[#11401C] focus-within:border-[#11401C] transition-all">
          ...
          <input
            type="text"
            placeholder="Search Video by ID"
