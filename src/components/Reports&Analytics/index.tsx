    ...
    return (
        <div className="">
            ...
            <div className="mt-4 flex items-center xl:items-start flex-col xl:flex-row gap-[17px]">
                <div className="w-full xl:w-[70%] bg-white rounded-[14px] py-[19px] px-[15px] shadow-md">
                    <SymptomsChart />
                </div>
                <div className="md:w-[50%] lg:w-[40%] xl:w-[30%] bg-white rounded-[14px] py-[14px] px-[10px] shadow-md">
                    <p className="text-black-100 font-medium text-[20px] pl-[10px]">Most Reported Allergies</p>
                    <div className="overflow-x-auto mt-4">
                        <table className="text-center">
                            <thead className="text-gray-50 font-semibold bg-[#F3F3F4] text-[14px]">
                                <tr>
