...
const BreadCrum: React.FC<BreadCrumProps> = ({ onSearch, setSelectedFilter, selectedFilter }) => {
    ...
    const options = ['Approved', 'Pending', 'Under Review', 'Rejected'];
    ...
    return (
        <div className="space-y-3">
            <div>
                <h1 className="text-[#11401C] font-semibold text-[24px]">Allergy Reports</h1>
                <p className="text-[#646464] font-medium text-[14px]">Review, verify, and manage user-submitted allergy reports.</p>
            </div>
