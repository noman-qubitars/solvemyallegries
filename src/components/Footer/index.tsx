...
const Footer: React.FC = () => {
    return (
        <>
            <div className="mt-[70px] bg-green flex justify-center items-center gap-4 py-[57px]">
                <p className="text-white font-poppins font-bold text-[24px] z-10">
                    Subscribe for Newsletter
                </p>
                <div className="bg-white rounded-full pl-[29px] pr-[10px] py-[15px] flex gap-2 items-center z-10">
                    <input type="text" placeholder="Your email" className="placeholder-gray-200 font-poppins font-normal outline-none border-none w-full" />
                    <button className="bg-green rounded-full px-[10px] py-[10px] flex justify-center items-center">
                        <IoIosSend className="text-white text-[24px]" />
                    </button>
                </div>
            </div>
            <div className="bg-green-250 py-[35px] px-[128px] flex flex-col items-center relative">
