...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {isVisible && (
        <button
          className="fixed bottom-20 z-40 cursor-pointer hidden sm:block sm:bottom-20 md:bottom-8 right-8 p-3 bg-green text-white rounded-full shadow-lg transition-all duration-300 ease-in-out"
          onClick={scrollToTop}
        >
          <IoIosArrowUp />
        </button>
